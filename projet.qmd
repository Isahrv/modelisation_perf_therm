...
```{r}
setwd("C:/Users/isali/OneDrive/Documents/cours/M1 ECAP/S2/Modélisation variables latentes/modelisation_perf_therm")
...
corrplot::corrplot(cor(df_complet),method="color",type="upper",
                   addCoef.col = "black",order="FPC")
...
# On remarque une structure de corrélation forte 
# => montre l'intérêt d'utiliser des méthodes à var latentes et de ne pas se limiter à la régression multiple
```
